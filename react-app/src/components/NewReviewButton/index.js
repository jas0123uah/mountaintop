...
export const ReviewButton = ({getaways, reservation}) => {
    ...
    const EditReview = <NavLink to={`/getaways/${getaways[reservation.getawayId].id}/reservations/${reservation.id}/reviews/${reservation.reviewId}/edit`}><button className="viewGetawayButton">Edit your review</button></NavLink>
    return(
<>
